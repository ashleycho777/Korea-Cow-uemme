...
class BlockItem:
    ...
    def orientations(self):
        # Sorted ascending by orientation ID: increasing orient_idx always means
    ...
    def raw_orient_idx(self) -> int:
        """Actual index of the current orientation within data['shape'] (the
        original unsorted array).  Used wherever a raw shape array is accessed
        directly, e.g. UtilsBlock."""
    ...
    def set_orient_from_raw_idx(self, raw_idx: int):
        """When loading a solution: convert a raw shape-array index into the
        sorted orient_idx and set it."""
